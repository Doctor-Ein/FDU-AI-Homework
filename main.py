...
if __name__ == '__main__':
    ...
    batch_size = 4  # TODO: batch_size's analysis
    ...
    train(trainloader, net, num_epochs, criterion, optimizer, save_path='TrainDataCollection')
